...
function (_React$PureComponent) {
  ...
  function DataTable() {
    ...
    _defineProperty(_assertThisInitialized(_this), "doSort", function (data, sortField) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHeaderClick", function (ev, columnValue) {
      var order;
