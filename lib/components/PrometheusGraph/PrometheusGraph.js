...
})(["position:relative;padding-left:", ";"], (0, _selectors.spacing)('xl'));
...
})(["position:relative;min-height:170px;margin-bottom:", ";opacity:", ";"], (0, _selectors.spacing)('medium'), function (props) {
...
function (_React$PureComponent) {
  ...
  function PrometheusGraph(_props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelectedLegendKeysChange", function (selectedLegendKeys) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHoveredLegendKeyChange", function (hoveredLegendKey) {
      _this.setState({
        hoveredLegendKey: hoveredLegendKey
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleHoverUpdate", function (_ref4) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChartResize", function (_ref5) {
      var chartWidth = _ref5.chartWidth,
          chartHeight = _ref5.chartHeight;

      _this.setState(_objectSpread({}, _this.prepareTimeAndValueScales(_this.props, _this.state.visibleMultiSeries), {
        chartHeight: chartHeight,
        chartWidth: chartWidth
      }));
    });

    _defineProperty(_assertThisInitialized(_this), "prepareMultiSeries", function (props) {
      ...
      selectedLegendKeys.length === 0 ? multiSeries : // Otherwise show only the selected multi series.
      multiSeries.filter(function (series) {
        return selectedLegendKeys.includes(series.key);
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "prepareTimeAndValueScales", function (props, multiseries) {
      var chartWidth;
      var chartHeight;
