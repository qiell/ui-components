...
var SeriesAreaChart = _styledComponents["default"].path.attrs({
  ...
  strokeWidth: function strokeWidth(_ref2) {
...
function (_React$PureComponent) {
  ...
  function Chart() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleGraphMouseMove", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleGraphMouseLeave", function () {
      _this.props.onHoverUpdate({
        hoverPoints: null,
