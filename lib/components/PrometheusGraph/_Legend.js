...
function (_React$PureComponent) {
  ...
  function Legend(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleLegendItemClick", function (ev, series) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleLegendItemMouseEnter", function (series) {
      _this.props.onHoveredKeyChange(series.key);
    });

    _defineProperty(_assertThisInitialized(_this), "handleLegendItemMouseLeave", function () {
      _this.props.onHoveredKeyChange(null);
    });

    _defineProperty(_assertThisInitialized(_this), "handleLegendToggle", function () {
      _this.setState({
        shown: !_this.state.shown
      });
    });

    _defineProperty(_assertThisInitialized(_this), "seriesSelected", function (series) {
      return _this.state.selectedKeys.includes(series.key);
    });

    _defineProperty(_assertThisInitialized(_this), "seriesHovered", function (series) {
