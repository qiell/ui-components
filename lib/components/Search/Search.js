...
function (_React$PureComponent) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "addSearchTerm", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "removeSearchTerm", function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInputKeyPress", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInputChange", function (ev) {
      _this.props.onChange(ev.target.value, _this.props.pinnedTerms);
    });

    _defineProperty(_assertThisInitialized(_this), "handleFilterChange", function (ev, value) {
      _this.input.focus();
