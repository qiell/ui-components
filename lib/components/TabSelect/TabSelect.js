...
function (_React$PureComponent) {
  ...
  function TabSelect() {
    ...
    _defineProperty(_assertThisInitialized(_this), "isSelectedTab", function (_ref) {
      var name = _ref.name;
      return name === _this.state.selectedTab;
    });

    _defineProperty(_assertThisInitialized(_this), "handleTabClick", function (ev, tabName) {
      _this.setState({
        selectedTab: tabName
      });
