...
function (_React$PureComponent) {
  ...
  function TimeTravel(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRangeChange", function (rangeMs) {
      _this.setState({
        rangeMs: rangeMs
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInputChange", function (timestamp) {
      _this.setFocusedTimestamp(timestamp);

      _this.props.onTimestampInputEdit();
    });

    _defineProperty(_assertThisInitialized(_this), "handleTimelineJump", function (timestamp) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimelinePanButtonClick", function (timestamp) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimelineZoom", function (duration) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimelinePan", function (timestamp) {
      // Order of callbacks is important.
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimelineRelease", function () {
      if (_this.shouldStickySwitchToLiveMode()) {
        // Order of callbacks is important.
        _this.setFocusedTimestamp(_this.state.timestampNow);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimelineResize", function (timelineWidthPx) {
      _this.setState({
        timelineWidthPx: timelineWidthPx
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleLiveModeToggle", function (showingLive) {
      if (showingLive) {
        // Order of callbacks is important.
        _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "switchToLiveMode", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "switchToPausedMode", function () {
      if (_this.props.hasLiveMode && _this.state.showingLive) {
        _this.setState({
          showingLive: false
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "setFocusedTimestamp", function (timestamp) {
      var focusedTimestamp = _this.clampedTimestamp(timestamp);
    ...
    _defineProperty(_assertThisInitialized(_this), "adjustZoomToRange", function (rangeMs) {
    ...
    _defineProperty(_assertThisInitialized(_this), "reportZoom", function () {
