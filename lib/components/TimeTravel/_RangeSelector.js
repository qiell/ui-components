...
function (_React$Component) {
  ...
  function RangeSelector(props, context) {
    ...
    _this.saveNodeRef = _this.saveNodeRef.bind(_assertThisInitialized(_this));
    _this.handleDropDownClick = _this.handleDropDownClick.bind(_assertThisInitialized(_this));
    _this.handleBackgroundClick = _this.handleBackgroundClick.bind(_assertThisInitialized(_this));
    return _this;
  }
